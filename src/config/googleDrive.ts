// Define these in your .env: VITE_GOOGLE_DRIVE_CLIENT_ID, VITE_GOOGLE_DRIVE_REDIRECT_URI
...
export const GOOGLE_DRIVE_CONFIG = {
  ...
  REDIRECT_URI: typeof window !== 'undefined'
    ...
    : (import.meta.env.VITE_GOOGLE_DRIVE_REDIRECT_URI as string) || '/auth/google-drive-callback.html',
